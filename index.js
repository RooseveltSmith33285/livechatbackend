...
let lastName=datazappResponse.data.ResponseDetail.Data[0]?.LastName?datazappResponse.data.ResponseDetail.Data[0]?.LastName:chat?.users[0]?.name?.split(' ')?.length>1?chat?.users[0]?.name?.split(' ')[1]:'N/A'
